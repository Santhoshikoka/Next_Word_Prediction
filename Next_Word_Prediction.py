...
with open(r"C:\\Users\\laxmi\\Desktop\\Word prediction\\sherlock-holm.es_stories_plain-text_advs.txt", 'r', encoding='utf-8') as file:
    text = file.read()
...
with open(r"C:\\Users\\laxmi\\Desktop\\Word prediction\\sherlock-holm.es_stories_plain-text_advs.txt") as file:
    text = file.read()

tokenizer = Tokenizer()
tokenizer.fit_on_texts([text])

model2= tf.keras.models.load_model(r"C:\\Users\\laxmi\\Desktop\\Word prediction\\model2.h5")
